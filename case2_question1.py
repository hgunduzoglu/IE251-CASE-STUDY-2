...
md1.idle_workers = pyo.Expression(rule = idle_workers_rule, doc="total idle workers")

def main_objective_rule(md1):
    #  different weights for objective functions
    ...
    #w1=0.8
    #w2=0.2
    return  ( ( w1* md1.total_cost / 2724637.5 ) +  ( w2 *  md1.idle_workers / 3171)  )  # scaleing
md1.main_objective = pyo.Objective(rule = main_objective_rule, sense=pyo.minimize,doc="Objective function value")
