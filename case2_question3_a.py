# goal programming, weighted sum method solution 
import case2_data 
...
def main_objective_rule(md1):
    ...
    return ( w1* md1.dv1_plus + w2* md1.dv2_plus)
...
md1.pprint()
md1.main_objective.display() # show value of objective function in console
...
dv1_plus_dict = md1.dv1_plus.extract_values()       # get deviation of cost excess from goal
dv1_minus_dict = md1.dv1_minus.extract_values()     # get deviation of cost slack from goal
dv2_plus_dict = md1.dv1_plus.extract_values()       # get deviation of idle excess from goal
dv2_minus_dict = md1.dv1_minus.extract_values()     # get deviation of idle slack from goal
