# goal programming, preemptive method. first priority is total cost goal
import case2_data 
...
#def main_objective_rule(md1):
   ...
   # return  md1.dv1_plus     # first objective to get the minimum value of dv1_plus
#md1.main_objective = pyo.Objective(rule = main_objective_rule, sense=pyo.minimize,doc="Objective value")

def dv1plus_constraint_rule(md1):
    return md1.dv1_plus == 0 
md1.dvplus_constraint = pyo.Constraint(rule = dv1plus_constraint_rule)
...
#dv2_plus_dict = md1.dv1_plus.extract_values()
#dv2_minus_dict = md1.dv1_minus.extract_values()
